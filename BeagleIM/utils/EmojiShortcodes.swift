...
class EmojiShortcodes {
    ...
    private static let dict = [
        ...
        "airplane": "\u{2708}",
        "aland_islands": "\u{1f1e6}\u{200D}\u{200D}1f1fd}",
        "alarm_clock": "\u{23f0}",
        ...
        "blond_haired_woman": "\u{1f471}\u{200D}\u{02640}",
        ...
        "bricks": "\u{1f9f1}",
        "bride_with_veil": "\u{1f470}\u{200D}\u{2640}",
        ...
        "email": "\u{1f4e7}",
        "end": "\u{1f51a}",
        "england": "\u{1f3f4}\u{200D}\u{e0067}\u{200D}\u{e0062}\u{200D}\u{e0065}\u{200D}\u{e006e}\u{200D}\u{e0067}\u{200D}\u{e007f}",
        "envelope": "\u{2709}",
        ...
        "scorpion": "\u{1f982}",
        "scorpius": "\u{264f}",
        "scotland": "\u{1f3f4}\u{200D}\u{e0067}\u{200D}\u{e0062}\u{200D}\u{e0073}\u{200D}\u{e0063}\u{200D}\u{e0074}\u{200D}\u{e007f}",
        "scream": "\u{1f631}",
        "scream_cat": "\u{1f640}",
        "screwdriver": "\u{1fa9b}",
        "scroll": "\u{1f4dc}",
        ...
        "waffle": "\u{1f9c7}",
        "wales": "\u{1f3f4}\u{200D}\u{e0067}\u{200D}\u{e0062}\u{200D}\u{e0077}\u{200D}\u{e006c}\u{200D}\u{e0073}\u{200D}\u{e007f}",
        "walking": "\u{1f6b6}",
...
//        let matchings = dict.keys.filter({ $0.contains(query) }).sorted();
//        if matchings.count > limit {
//            return Array(matchings[0..<limit]);
//        } else {
//            return matchings;
//        }
//    }
    ...
    static func emoji(for key: String) -> String? {
        return dict[key]?.precomposedStringWithCompatibilityMapping
    }
